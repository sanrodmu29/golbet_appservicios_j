...
public abstract class AuditableEntity
{
    ...
    public DateTime? ModifiedDate { get; set; } // ESE ? ES PORQUE ESE METODO ES NULLABLE, PARA QUE NO SEA OBLIGATORIO, YA QUE AL CREAR EL REGISTRO NO HAY MODIFICACION TODAVIA
