...
public class Bet : AuditableEntity
{
    ...
    public Match Match { get; set; } = null!; // UNA APUESTA PERTENECE A UN SOLO PARTIDO, PERO UN PARTIDO PUEDE TENER MUCHAS APUESTAS, POR ESO ES UNA RELACION DE MUCHOS A UNO
